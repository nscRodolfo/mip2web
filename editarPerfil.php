...
<section id="adicionar">
            <form action="editarUsu.php" method="POST">
                <table> <tr><td>  <h6>Nome do produtor: </h6> </td> <td> <input type="text" name="nome" value="<?php echo $nome ?>" required>
            </input> </td> </tr>

            <tr><td>  <h6>Telefone: </h6> </td> <td> <input type="text" name="telefone" value="<?php echo $tel ?>" minlength="10" maxlength="11" required> 
            </input>    
            </td></tr>
