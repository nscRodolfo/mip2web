...
<hr size = 7>
            ...
            <form action="adicionarPBanco.php" method="POST">
                <table> <tr><td>  <h6>Nome da propriedade: </h6> </td> <td> <input type="text" name="nomePropriedade" placeholder="Ex: Fazenda..." required>
            </input> </td> </tr>

            <tr><td>   <h6>Cidade: </h6></td> <td> <input type="text" name="cidade" placeholder="Ex: Rio Pomba" required>
            </input>
            </td></tr>

            <tr><td>  <h6>Estado: </h6> </td> <td> <input type="text" name="estado" placeholder="Ex: MG, SP, RJ ..." maxlength="2" required> 
            </input>    
            </td></tr>
